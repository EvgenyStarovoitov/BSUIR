...
//   Секция элемента отрисовки
    ...
    class CanvasEl {
        ...
        findCoord(res,e){
            // при нажатой клавиши начинаеться отрисовка по движению мыши
            if (res == 'down') {
                prevX = currX;
                prevY = currY;
                currX = e.clientX; 
            ...
            // при отжатой клавише или когда мышь за пределами холста для рисования исключает возможность прорисовки
            if (res == 'up' || res == "out") {
                flag = false;
            };
